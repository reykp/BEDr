...
library(gridExtra)
jpeg(file = "D:\\Documents\\Dissertation - Summer 2018\\Latex Dissertation\\Images\\V_GoldTest2.jpg", width=1094, height=541)
...
# edges of the data
gold_bimodal_400 <- gold(y = y_bimodal_400,s1 = 0.8, c1 = 20, c2 = 12, s2 = .04, poi = c(-2.111, 1.153, 6.234), scale_l = 1, scale_u = 1, N = 30000)

gold_bimodal_400$ar


save(gold_bimodal_400, file = "R Objects/gold_bimodal_400.RData")
...
data.frame(gold_bimodal_400$G[,c(1,200,400,437)]) %>% 
  ...
  ggplot()+geom_histogram(aes(Simulation), fill = "grey", color = "black")+theme_bw()+theme(text = element_text(size=25))+xlab("g(x)")+facet_wrap(~Parameter)+add_theme
dev.off()
```
...
# Plot six of the trace plots for 
# output from 'gold'
jpeg(file = "D:\\Documents\\Dissertation - Summer 2018\\Latex Dissertation\\Images\\V_Gold_Norm_TP.jpg", width=1094, height=541)
...
dev.off()
 ...
 jpeg(file = "D:\\Documents\\Dissertation - Summer 2018\\Latex Dissertation\\Images\\V_Gold_Exp_acf.jpg", width=1094, height=541)
...
gold_mcmcplots(gold_bimodal_400, burnin = 5000)
dev.off()
```
...
# Simulate 500 values from beta(2,5)
y_beta_500 <- rbeta(500, 2, 5)

# Run 'gold' with the default prior for data of size 50
gold_beta_500 <- gold(y = y_beta_500, s1 = 2.15, c1 = 1)

# First check the acceptance rate
gold_beta_500$ar

[1] 0.4940747

 jpeg(file = "D:\\Documents\\Dissertation - Summer 2018\\Latex Dissertation\\Images\\V_Gold_Beta_tp.jpg", width=1094, height=541)
gold_mcmcplots(gold_beta_500)
dev.off()


 jpeg(file = "D:\\Documents\\Dissertation - Summer 2018\\Latex Dissertation\\Images\\V_Gold_Beta_acf.jpg", width=1094, height=541)
gold_mcmcplots(gold_beta_500, type = "acf")
dev.off()

# Run 'gold' with the default prior for data of size 50
gold_beta_500_s1 <- gold(y = y_beta_500, s1 = .6, c1 = 1)

gold_beta_500_c1 <- gold(y = y_beta_500, s1 = 2.15, c1 = 10)
...
dev.off()
 ...
 jpeg(file = "D:\\Documents\\Dissertation - Summer 2018\\Latex Dissertation\\Images\\V_Gold_norm_pp.jpg", width=1094,height=541)
gold_pp(gold_normal, npar = 10)
dev.ff()

jpeg(file = "D:\\Documents\\Dissertation - Summer 2018\\Latex Dissertation\\Images\\V_Gold_beta_pp.jpg", width=1094,height=541)
...
input <- runif(1000, -4.2, 4.2)
 jpeg(file = "D:\\Documents\\Dissertation - Summer 2018\\Latex Dissertation\\Images\\V_Gold_norm_pdf.jpg", width=1094, height=541)
gold_plot(gold_normal)+stat_function(fun = dnorm, color = "red", linetype = 2, size = .8) +add_theme+add_theme
dev.off()
```
...
gold_plot(gold_unif_50, type = "cdf")+add_theme
dev.off()
...
jpeg(file = "D:\\Documents\\Dissertation - Summer 2018\\Latex Dissertation\\Images\\V_Gold_exp_pdf.jpg", width=1094, height=541)
gold_plot(gold_exp_200, burnin = 5000)+add_theme
dev.off()
...
```{r}
# Plot the GOLD estimate of the PDF on the 
# $unif(0,1)$ data with credible intervals
g1 <- gold_plot(gold_unif_50, cri = TRUE)+add_theme

# Plot the GOLD estimate of the PDF on the 
# 'bimodal' data with credible intervals
g2 <-gold_plot(gold_bimodal_400, cri = TRUE)+add_theme

# Plot the GOLD estimate of the CDF on the 
# $exp(1)$ data with credible intervals
g3 <- gold_plot(gold_exp_200, type = "cdf", cri = TRUE, burnin = 5000)+add_theme

# Plot the GOLD estimate of the CDF on the 
# $N(0,1)$ data with credible intervals
g4 <- gold_plot(gold_normal, type = "cdf", cri = TRUE)+add_theme

library(gridExtra)
jpeg(file = "D:\\Documents\\Dissertation - Summer 2018\\Latex Dissertation\\Images\\V_Gold_cri_grid.jpg", width=1094, height=541)
grid.arrange(g1, g2, g3, g4)
dev.off()
...
g1 <- gold_plot(gold_unif_50, data = TRUE)+ggtitle("Uniform")+add_theme
g2 <- gold_plot(gold_normal, data = TRUE)+ggtitle("Normal")+add_theme
g3 <- gold_plot(gold_exp_200, data = TRUE, burnin = 5000)+ggtitle("Exponential")+add_theme
g4 <- gold_plot(gold_bimodal_400, data = TRUE)+ggtitle("Bimodal")+add_theme
...
g1 <- gold_plot(gold_unif_50, type = "cdf", data = TRUE)+ggtitle("Uniform")+add_theme
g2 <- gold_plot(gold_normal_alt, type = "cdf", data = TRUE)+ggtitle("Normal")+add_theme
g3 <- gold_plot(gold_exp_200, type = "cdf", data = TRUE, burnin = 5000)+ggtitle("Exponential")+add_theme
g4 <- gold_plot(gold_bimodal_400, type = "cdf", data = TRUE)+ggtitle("Bimodal")+add_theme
...
gold_plot(gold_bimodal_400, data = TRUE, cri = TRUE)+add_theme
dev.off()

jpeg(file = "D:\\Documents\\Dissertation - Summer 2018\\Latex Dissertation\\Images\\V_Gold_cdf_bimodal_cri_data.jpg", width=1094, height=541)
gold_plot(gold_bimodal_400, type = "cdf", data = TRUE, cri = TRUE)+add_theme
dev.off()
...
gold_plot(gold_exp_200, type = "cdf", interact = TRUE, cri = TRUE, data = TRUE)
...
geom_histogram(alpha = 0.5, bins = 40)+
theme_bw()+theme(axis.title = element_text(size = 12))+
facet_wrap(~Variable, nrow = 4)+add_theme
dev.off()
```

```{r}

gold_exp_pdf <- gold_pdf(x = c(min(gold_exp_200$y), max(gold_exp_200$y)), gold_exp_200, burnin = 5000)
...
# the exp(1) data
gold_cdf_exp <- gold_cdf(x = c(1, 4), gold_output = gold_exp_200, burnin = 5000)
...
gold_cdf_bimodal <- gold_cdf(x = c(-0.52, 4), gold_output = gold_bimodal_400)
...
# Add (-0.52, 4) to the original list of points of interest
# in order to acquire their posterior
# draws in order to create credible intervals,
gold_bimodal_400_poi <- gold(y = y_bimodal_400,s1 = 0.8, c1 = 20, c2 = 12, s2 = .04, poi = c(-2.111, 1.153, 6.234,-0.52, 4), scale_l = 1, scale_u = 1, N = 30000)

# Run the CDF function again
gold_cdf_bimodal_poi <- gold_cdf(x = c(-0.52, 4), gold_output = gold_bimodal_400_poi)

# Get the posterior simulations for the CDF at (-0.52, 4)
probs <- data.frame(gold_cdf_bimodal_poi$mat)

# Calculate the probability of being greater than 4
probs[,2] <- 1-probs[,2]
...
jpeg(file = "D:\\Documents\\Dissertation - Summer 2018\\Latex Dissertation\\Images\\V_gold_mode_comp.jpg", width=1094, height=541)
...
jpeg(file = "D:\\Documents\\Dissertation - Summer 2018\\Latex Dissertation\\Images\\V_gold_mean_mat_norm.jpg", width=1094, height=541)
data.frame(Mean = gold_mean_norm$mat) %>%
  ggplot()+
...
# a burnin of 5,000
gold_bimodal_quant <- gold_stat(gold_bimodal_400, stat = "q", p = c(0.25, 0.5, 0.75))
...
```
```{r}
# Get the posterior mean of the expectation
gold_stat(gold_exp_200, stat = "m", burnin = 5000, print = FALSE)$mean

[1] 1.094266

# Get the posterior mean of the variance
gold_stat(gold_exp_200, stat = "v", burnin = 5000, print = FALSE)$variance

[1] 1.612343

# Get the posterior mean of the median
gold_stat(gold_exp_200, stat = "q", p = 0.5, burnin = 5000, print = FALSE)$quantiles
...
```{r, eval = FALSE}
gold_unif_all <- gold(y = runif(250))
#save(gold_unif_all, file = "R Objects/gold_unif_all.RData")
gold_beta_all <- gold(y = rbeta(250,2,5))
#save(gold_beta_all, file = "R Objects/gold_beta_all.RData")
gold_normal_all <- gold(y = rnorm(250))
#save(gold_normal_all, file = "R Objects/gold_normal_all.RData")

gold_exponential_all <- gold(y = rexp(250,1))
#save(gold_exponential_all, file = "R Objects/gold_exponential_all")

gold_arcsin_all <- gold(y = rbeta(250,.5,.5))
...
gold_bimodal_all <- gold(y = y_bimodal_250)
#save(gold_bimodal_all, file = "R Objects/gold_bimodal_all.RData")


gold_jagged_all <- gold(y = y_jagged_250)
#save(gold_jagged_all, file = "R Objects/gold_jagged_all.RData")

gold_trimodal_all <- gold(y = y_trimodal_250)
#save(gold_trimodal_all, file = "R Objects/gold_trimodal_all.RData")

gold_claw_all <- gold(y = y_claw_250)

#save(gold_claw_all, file = "R Objects/gold_claw_all.RData")

```

```{r}
load("R Objects/gold_claw_all.RData")
load("R Objects/gold_unif_all.RData")
load("R Objects/gold_jagged_all.RData")
load("R Objects/gold_trimodal_all.RData")
load("R Objects/gold_beta_all.RData")
load("R Objects/gold_bimodal_all.RData")
load("R Objects/gold_arcsin_all.RData")
load("R Objects/gold_normal_all.RData")
load("R Objects/gold_exp.RData")
input <- runif(1000)

add_theme <<- theme(text = element_text(size = 22))+theme(axis.text.x = element_text(size = 20), axis.text.y = element_text(size = 20))

p1 <- gold_plot(gold_unif_all, data = TRUE)+geom_line(data = data.frame(X = input, Y  =rep(1,length(input))), aes(X,Y), color = "red",size = 1)+ ggplot2::ylab("")+ggplot2::theme(text = ggplot2::element_text(size=20))+ggplot2::ggtitle("Uniform")+ggplot2::xlab("")+add_theme



p2 <- gold_plot(gold_beta_all, data = TRUE)+geom_line(data = data.frame(X = input, Y = dbeta(input,2,5)), aes(X,Y), color = "red", size = 1)+ggplot2::ylab("")+ggplot2::theme(text = ggplot2::element_text(size=20))+ggplot2::ggtitle("Beta")+ggplot2::xlab("")+add_theme

  input_n <- input*(max(gold_normal_all$y)+.00001-(min(gold_normal_all$y)-.00001))+(min(gold_normal_all$y)-.00001)
  
p3 <- gold_plot(gold_normal_all, data = TRUE)+geom_line(data = data.frame(X = input_n, Y = dnorm(input_n,0,1)), aes(X,Y), color = "red", size = 1)+ggplot2::ylab("")+ggplot2::theme(text = ggplot2::element_text(size=20))+ggplot2::ggtitle("Normal")+ggplot2::xlab("")+add_theme

   input_n <- input*(max(gold_exponential_all$y)+.00001-(min(gold_exponential_all$y)-.00001))+(min(gold_exponential_all$y)-.00001)
input_n <- input_n[input_n>=0]
p4 <- gold_plot(gold_exponential_all, data = TRUE)+geom_line(data = data.frame(X = input_n, Y  =dexp(input_n,1)), aes(X,Y), color = "red",size = 1)+ggplot2::ylab("")+ggplot2::theme(text = ggplot2::element_text(size=20))+ggplot2::ggtitle("Exponential")+ggplot2::xlab("")+add_theme+expand_limits(x=0)

p5 <- gold_plot(gold_arcsin_all, data = TRUE)+geom_line(data = data.frame(X = input, Y  =dbeta(input,0.5,0.5)), aes(X,Y), color = "red",size = 1)+ggplot2::ylab("")+ggplot2::theme(text = ggplot2::element_text(size=20))+ggplot2::ggtitle("Arcsin")+ggplot2::xlab("")+add_theme

    input_n <- input*(max(gold_bimodal_all$y)+.00001-(min(gold_bimodal_all$y)-.00001))+(min(gold_bimodal_all$y)-.00001)
      Y <- (.3*dnorm(input_n)+.7*dnorm(input_n,4,1))
      
p6 <- gold_plot(gold_bimodal_all, data = TRUE)+geom_line(data = data.frame(X = input_n, Y  =Y), aes(X,Y), color = "red",size = 1)+ggplot2::ylab("")+ggplot2::theme(text = ggplot2::element_text(size=20))+ggplot2::ggtitle("Bimodal")+ggplot2::xlab("")+add_theme
...
Y <-NA
      ...
      Y[input>=.6 & input <.8] <- -2.5+5*input[input>=.6 & input<.8]
      Y[input>=.8 & input <1] <- 5.5-5*input[input>=.8 & input<1]
p7 <- gold_plot(gold_jagged_all, data = TRUE)+geom_line(data = data.frame(X = input, Y  =Y), aes(X,Y), color = "red",size = 1)+ggplot2::ylab("")+ggplot2::theme(text = ggplot2::element_text(size=20))+ggplot2::ggtitle("Jagged")+ggplot2::xlab("")+add_theme

    input_n <- input*(max(gold_trimodal_all$y)+.00001-(min(gold_trimodal_all$y)-.00001))+(min(gold_trimodal_all$y)-.00001)
      Y <- (.2*dnorm(input_n)+.3*dnorm(input_n,6,1)+.5*dnorm(input_n,2,.1))

p8 <- gold_plot(gold_trimodal_all, data = TRUE)+geom_line(data = data.frame(X = input_n, Y  =Y), aes(X,Y), color = "red",size = 1)+ggplot2::ylab("")+ggplot2::theme(text = ggplot2::element_text(size=20))+ggplot2::ggtitle("Trimodal")+ggplot2::xlab("")+add_theme

   input_n <- input*(max(gold_claw_all$y)+.00001-(min(gold_claw_all$y)-.00001))+(min(gold_claw_all$y)-.00001)
   
 Y <- (.5*dnorm(input_n)+.1*dnorm(input_n,-1,.1)+.1*dnorm(input_n,-.5,.1)+.1*dnorm(input_n,0,.1)+.1*dnorm(input_n,.5,.1)+.1*dnorm(input_n,1,.1))

 p9 <- gold_plot(gold_claw_all, data = TRUE)+geom_line(data = data.frame(X = input_n, Y  =Y), aes(X,Y), color = "red",size = 1)+ggplot2::ylab("")+ggplot2::theme(text = ggplot2::element_text(size=20))+ggplot2::ggtitle("Claw")+ggplot2::xlab("")+add_theme
...
p1 <- gold_plot(gold_unif_all, type = "cdf", data = TRUE)+geom_line(data = data.frame(X = input, Y  =input), aes(X,Y), color = "red",size = 1)+ ggplot2::ylab("")+ggplot2::theme(text = ggplot2::element_text(size=20))+ggplot2::ggtitle("Uniform")+ggplot2::xlab("")+add_theme


p2 <- gold_plot(gold_beta_all, type = "cdf", data = TRUE)+geom_line(data = data.frame(X = input, Y = pbeta(input,2,5)), aes(X,Y), color = "red", size = 1)+ggplot2::ylab("")+ggplot2::theme(text = ggplot2::element_text(size=20))+ggplot2::ggtitle("Beta")+ggplot2::xlab("")+add_theme

  input_n <- input*(max(gold_normal_all$y)+.00001-(min(gold_normal_all$y)-.00001))+(min(gold_normal_all$y)-.00001)
  
p3 <- gold_plot(gold_normal_all, type = "cdf", data = TRUE)+geom_line(data = data.frame(X = input_n, Y = pnorm(input_n,0,1)), aes(X,Y), color = "red", size = 1)+ggplot2::ylab("")+ggplot2::theme(text = ggplot2::element_text(size=20))+ggplot2::ggtitle("Normal")+ggplot2::xlab("")+add_theme

   input_n <- input*(max(gold_exponential_all$y)+.00001-(min(gold_exponential_all$y)-.00001))+(min(gold_exponential_all$y)-.00001)
input_n <- input_n[input_n>=0]
p4 <- gold_plot(gold_exponential_all, type = "cdf", data = TRUE)+geom_line(data = data.frame(X = input_n, Y  =pexp(input_n,1)), aes(X,Y), color = "red",size = 1)+ggplot2::ylab("")+ggplot2::theme(text = ggplot2::element_text(size=20))+ggplot2::ggtitle("Exponential")+ggplot2::xlab("")+add_theme+expand_limits(x=0)

p5 <- gold_plot(gold_arcsin_all, type = "cdf", data = TRUE)+geom_line(data = data.frame(X = input, Y  =pbeta(input,0.5,0.5)), aes(X,Y), color = "red",size = 1)+ggplot2::ylab("")+ggplot2::theme(text = ggplot2::element_text(size=20))+ggplot2::ggtitle("Arcsin")+ggplot2::xlab("")+add_theme

    input_n <- input*(max(gold_bimodal_all$y)+.00001-(min(gold_bimodal_all$y)-.00001))+(min(gold_bimodal_all$y)-.00001)
      Y <- (.3*pnorm(input_n)+.7*pnorm(input_n,4,1))
      
p6 <- gold_plot(gold_bimodal_all, type = "cdf",data = TRUE)+geom_line(data = data.frame(X = input_n, Y  =Y), aes(X,Y), color = "red",size = 1)+ggplot2::ylab("")+ggplot2::theme(text = ggplot2::element_text(size=20))+ggplot2::ggtitle("Bimodal")+ggplot2::xlab("")+add_theme
...
Y <-NA
     Y[input>=0 & input <.2] <- 1.5*input[input>=0 & input<.2]-(5*input[input>=0 & input<.2]^2)/2
      ...
      Y[input>=.6 & input <.8] <- (5*input[input>=.6 & input<.8]^2)/2-2.5*input[input>=.6 & input<.8]+1.2
      Y[input>=.8 & input <1] <- (-5*input[input>=.8 & input<1]^2)/2+5.5*input[input>=.8 & input<1]-2
p7 <- gold_plot(gold_jagged_all, type = "cdf", data = TRUE)+geom_line(data = data.frame(X = input, Y  =Y), aes(X,Y), color = "red",size = 1)+ggplot2::ylab("")+ggplot2::theme(text = ggplot2::element_text(size=20))+ggplot2::ggtitle("Jagged")+ggplot2::xlab("")+add_theme

    input_n <- input*(max(gold_trimodal_all$y)+.00001-(min(gold_trimodal_all$y)-.00001))+(min(gold_trimodal_all$y)-.00001)
      Y <- (.2*pnorm(input_n)+.3*pnorm(input_n,6,1)+.5*pnorm(input_n,2,.1))

p8 <- gold_plot(gold_trimodal_all, type = "cdf", data = TRUE)+geom_line(data = data.frame(X = input_n, Y  =Y), aes(X,Y), color = "red",size = 1)+ggplot2::ylab("")+ggplot2::theme(text = ggplot2::element_text(size=20))+ggplot2::ggtitle("Trimodal")+ggplot2::xlab("")+add_theme

   input_n <- input*(max(gold_claw_all$y)+.00001-(min(gold_claw_all$y)-.00001))+(min(gold_claw_all$y)-.00001)
   
 Y <- (.5*pnorm(input_n)+.1*pnorm(input_n,-1,.1)+.1*pnorm(input_n,-.5,.1)+.1*pnorm(input_n,0,.1)+.1*pnorm(input_n,.5,.1)+.1*pnorm(input_n,1,.1))

 p9 <- gold_plot(gold_claw_all, type = "cdf", data = TRUE)+geom_line(data = data.frame(X = input_n, Y  =Y), aes(X,Y), color = "red",size = 1)+ggplot2::ylab("")+ggplot2::theme(text = ggplot2::element_text(size=20))+ggplot2::ggtitle("Claw")+ggplot2::xlab("")+add_theme
