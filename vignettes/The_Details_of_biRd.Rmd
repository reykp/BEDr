...
```{r, eval = FALSE}
duos_unif_all <- duos(y = distr_gather$value[distr_gather$variable=="Uniform"], k = 3)
#save(duos_unif_all, file = "R Objects/duos_unif_all.RData")
duos_beta_all <- duos(y = distr_gather$value[distr_gather$variable=="Beta"])
#save(duos_beta_all, file = "R Objects/duos_beta_all.RData")
duos_normal_all <- duos(y = distr_gather$value[distr_gather$variable=="Normal"], 
                        scale_l = 2*sd(distr_gather$value[distr_gather$variable=="Normal"]),
                        scale_u = 2*sd(distr_gather$value[distr_gather$variable=="Normal"]))
#save(duos_normal_all, file = "R Objects/duos_normal_all.RData")
duos_exponential_all <- duos(y = distr_gather$value[distr_gather$variable=="Exponential"])
#save(duos_beta_all, file = "R Objects/duos_beta_all.RData")

duos_arcsin_all <- duos(y = distr_gather$value[distr_gather$variable=="Arcsin"])
#save(duos_arcsin_all, file = "R Objects/duos_arcsin_all.RData")

duos_bimodal_all <- duos(y = distr_gather$value[distr_gather$variable=="Bimodal"], k = 7)
#save(duos_bimodal_all, file = "R Objects/duos_bimodal_all.RData")


duos_jagged_all <- duos(y = distr_gather$value[distr_gather$variable=="Jagged"], k = 8)
#save(duos_jagged_all, file = "R Objects/duos_jagged_all.RData")

duos_trimodal_all <- duos(y = distr_gather$value[distr_gather$variable=="Trimodal"])
#save(duos_trimodal_all, file = "R Objects/duos_trimodal_all.RData")

duos_claw_all <- duos(y = distr_gather$value[distr_gather$variable=="Claw"], k = 10,
                      scale_l = 0.5, scale_u = 0.5)
...
p1 <- duos_plot(duos_unif_all, data = TRUE)+ggplot2::ylab("")+ggplot2::theme(text = ggplot2::element_text(size=20))+ggplot2::ggtitle("Uniform PDF")
p2 <- duos_plot(duos_beta_all, data = TRUE)+ggplot2::ylab("")+ggplot2::theme(text = ggplot2::element_text(size=20))+ggplot2::ggtitle("Beta PDF")
p3 <- duos_plot(duos_normal_all, data = TRUE)+ggplot2::ylab("")+ggplot2::theme(text = ggplot2::element_text(size=20))+ggplot2::ggtitle("Normal PDF")
p4 <- duos_plot(duos_exp, data = TRUE)+ggplot2::ylab("")+ggplot2::theme(text = ggplot2::element_text(size=20))+ggplot2::ggtitle("Exponential PDF")
p5 <- duos_plot(duos_arcsin_all, data = TRUE)+ggplot2::ylab("")+ggplot2::theme(text = ggplot2::element_text(size=20))+ggplot2::ggtitle("Arcsin PDF")
p6 <- duos_plot(duos_bimodal_all, data = TRUE)+ggplot2::ylab("")+ggplot2::theme(text = ggplot2::element_text(size=20))+ggplot2::ggtitle("Bimodal PDF")
p7 <- duos_plot(duos_jagged_all, data = TRUE)+ggplot2::ylab("")+ggplot2::theme(text = ggplot2::element_text(size=20))+ggplot2::ggtitle("Jagged PDF")
p8 <- duos_plot(duos_trimodal_all, data = TRUE)+ggplot2::ylab("")+ggplot2::theme(text = ggplot2::element_text(size=20))+ggplot2::ggtitle("Trimodal PDF")
p9 <- duos_plot(duos_claw_all, data = TRUE)+ggplot2::ylab("")+ggplot2::theme(text = ggplot2::element_text(size=20))+ggplot2::ggtitle("Claw PDF")
...
p1 <- duos_plot(duos_unif_all, type = "cdf")+ggplot2::ylab("")+ggplot2::theme(text = ggplot2::element_text(size=20))+ggplot2::ggtitle("Uniform CDF")
p2 <- duos_plot(duos_beta_all, type = "cdf")+ggplot2::ylab("")+ggplot2::theme(text = ggplot2::element_text(size=20))+ggplot2::ggtitle("Beta CDF")
p3 <- duos_plot(duos_normal_all, type = "cdf")+ggplot2::ylab("")+ggplot2::theme(text = ggplot2::element_text(size=20))+ggplot2::ggtitle("Normal CDF")
p4 <- duos_plot(duos_exp, type = "cdf")+ggplot2::ylab("")+ggplot2::theme(text = ggplot2::element_text(size=20))+ggplot2::ggtitle("Exponential CDF")
p5 <- duos_plot(duos_arcsin_all, type = "cdf")+ggplot2::ylab("")+ggplot2::theme(text = ggplot2::element_text(size=20))+ggplot2::ggtitle("Arcsin CDF")
p6 <- duos_plot(duos_bimodal_all, type = "cdf")+ggplot2::ylab("")+ggplot2::theme(text = ggplot2::element_text(size=20))+ggplot2::ggtitle("Bimodal CDF")
p7 <- duos_plot(duos_jagged_all, type = "cdf")+ggplot2::ylab("")+ggplot2::theme(text = ggplot2::element_text(size=20))+ggplot2::ggtitle("Jagged CDF")
p8 <- duos_plot(duos_trimodal_all, type = "cdf")+ggplot2::ylab("")+ggplot2::theme(text = ggplot2::element_text(size=20))+ggplot2::ggtitle("Trimodal CDF")
p9 <- duos_plot(duos_claw_all, type = "cdf")+ggplot2::ylab("")+ggplot2::theme(text = ggplot2::element_text(size=20))+ggplot2::ggtitle("Claw CDF")
...
```{r}
#Test on Uniform, Normal, Exp, Bimodal 
#xxxxxxx
```
#### Density Estimation
