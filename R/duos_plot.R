...
#' @details
#'
#' The form of the density whose paramters are estimated in \code{duos} is below:
#'
#' \deqn{f(x) =}
#'
...
#' duos_plot(duos_unif, type="cdf", cri=TRUE, data=TRUE)
#'
#' ## --------------------------------------------------------------------------------
#' ## Beta Distribution
#' ## --------------------------------------------------------------------------------
...
#' duos_plot(duos_bimodal, type="cdf", data=TRUE)
#'



duos_plot <- function(duos_output,type="pdf",burnin=NA, cri=FALSE, data=FALSE){

  if(type=="pdf"){
    helper_duos_pdf_plot(duos_output, burnin, cri, data)
  }else if (type=="cdf"){
    helper_duos_cdf_plot(duos_output, burnin, cri, data)
  }
}
