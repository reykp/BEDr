#' Plot CDF from DUOS.
#'
#' Plots the CDF estimate based on the output from DUOS.
#'
...
#' @param data An option to overlay empirical CDF
#'
#' @export


duos_cdf_plot <- function(duos_output,burnin=NA, cr_i=FALSE, data=FALSE){
